...
class Asama5Soru4 extends StatefulWidget {
  const Asama5Soru4({super.key});

  @override
  State<Asama5Soru4> createState() => _Asama5Soru4State();
}
...
class _Asama5Soru4State extends State<Asama5Soru4>
  ...
  void initState() {
    ...
    stages = [
      _AdvancedStage(
        'İlk',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru4/Resim1.png',
      ),
      _AdvancedStage(
        'İkinci',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru4/Resim2.png',
      ),
      _AdvancedStage(
        'Üçüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru4/Resim3.png',
      ),
      _AdvancedStage(
        'Dördüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru4/Resim4.png',
      ),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama5Soru5()),
          );
        }
      });
    } else {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              isEnglish
                                  ? 'Sort the stages of washing clothes.'
                                  : 'Çamaşır yıkama aşamalarını sırala.',
