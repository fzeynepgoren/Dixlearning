...
class Asama5Soru3 extends StatefulWidget {
  const Asama5Soru3({super.key});

  @override
  State<Asama5Soru3> createState() => _Asama5Soru3State();
}
...
class _Asama5Soru3State extends State<Asama5Soru3>
  ...
  void initState() {
    ...
    stages = [
      _AdvancedStage(
        'İlk',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru3/Resim1.png',
      ),
      _AdvancedStage(
        'İkinci',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru3/Resim2.png',
      ),
      _AdvancedStage(
        'Üçüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru3/Resim3.png',
      ),
      _AdvancedStage(
        'Dördüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru3/Resim4.png',
      ),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama5Soru4()),
          );
        }
      });
    } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  isEnglish
                                      ? 'Sort the stages of withdrawing money.'
                                      : 'Para çekme aşamalarını sırala.',
