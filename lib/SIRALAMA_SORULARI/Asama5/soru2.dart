...
class Asama5Soru2 extends StatefulWidget {
  const Asama5Soru2({super.key});

  @override
  State<Asama5Soru2> createState() => _Asama5Soru2State();
}
...
class _Asama5Soru2State extends State<Asama5Soru2>
  ...
  void initState() {
    ...
    stages = [
      _AdvancedStage(
        'İlk',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru2/Resim1.png',
      ),
      _AdvancedStage(
        'İkinci',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru2/Resim2.png',
      ),
      _AdvancedStage(
        'Üçüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru2/Resim3.png',
      ),
      _AdvancedStage(
        'Dördüncü',
        'assets/SIRALAMA_RESIMLERI/Asama5/soru2/Resim4.png',
      ),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama5Soru3()),
          );
        }
      });
    } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  isEnglish
                                      ? 'Sort the stages of going shopping.'
                                      : 'Alışveriş aşamalarını sırala.',
