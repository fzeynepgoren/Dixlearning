...
class Asama1Soru2 extends StatefulWidget {
  const Asama1Soru2({super.key});

  @override
  State<Asama1Soru2> createState() => _Asama1Soru2State();
}
...
class _Asama1Soru2State extends State<Asama1Soru2>
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama1Soru3()),
          );
        }
      });
    } else {
