...
class Asama1Soru4 extends StatefulWidget {
  const Asama1Soru4({super.key});

  @override
  State<Asama1Soru4> createState() => _Asama1Soru4State();
}
...
class _Asama1Soru4State extends State<Asama1Soru4>
  ...
  void initState() {
    super.initState();
    stages = [
      _ItemStage('Bos', 'assets/SIRALAMA_RESIMLERI/Asama1/soru4/bos.png'),
      _ItemStage('Yarim', 'assets/SIRALAMA_RESIMLERI/Asama1/soru4/yarim.png'),
      _ItemStage('Dolu', 'assets/SIRALAMA_RESIMLERI/Asama1/soru4/dolu.png'),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama1Soru5()),
          );
        }
      });
    } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  isEnglish
                                      ? 'Sort the glasses from empty to full.'
                                      : 'Bardakları boştan doluya doğru sırala.',
