...
class _Asama1Soru1State extends State<Asama1Soru1>
  ...
  void initState() {
    super.initState();
    stages = [
      _ItemStage('Kısa', 'assets/SIRALAMA_RESIMLERI/Asama1/soru1/kisa.png'),
      _ItemStage('Orta', 'assets/SIRALAMA_RESIMLERI/Asama1/soru1/orta.png'),
      _ItemStage('Uzun', 'assets/SIRALAMA_RESIMLERI/Asama1/soru1/uzun.png'),
    ];
