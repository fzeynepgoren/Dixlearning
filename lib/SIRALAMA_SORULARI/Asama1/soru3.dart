...
class Asama1Soru3 extends StatefulWidget {
  ...
  @override
  State<Asama1Soru3> createState() => _Asama1Soru3State();
}
...
class _Asama1Soru3State extends State<Asama1Soru3>
  ...
  void initState() {
    ...
    stages = [
      _ItemStage(
        'İlk',
        'assets/SIRALAMA_RESIMLERI/Asama1/soru3/resim1.png',
      ),
      _ItemStage(
        'İkinci',
        'assets/SIRALAMA_RESIMLERI/Asama1/soru3/resim2.png',
      ),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama1Soru4()),
          );
        }
      });
    } else {
