...
class Asama4Soru1 extends StatefulWidget {
  ...
  @override
  State<Asama4Soru1> createState() => _Asama4Soru1State();
}
...
class _Asama4Soru1State extends State<Asama4Soru1>
  ...
  void initState() {
    super.initState();
    stages = [
      _Stage('1', 'assets/SIRALAMA_RESIMLERI/Asama4/elyikama/el1.png'),
      _Stage('2', 'assets/SIRALAMA_RESIMLERI/Asama4/elyikama/el2.png'),
      _Stage('3', 'assets/SIRALAMA_RESIMLERI/Asama4/elyikama/el3.png'),
    ];
  ...
  Future<void> _initializeSession() async {
    ...
    await prefs.setInt('asama4_session_correct_count', 0);
    await prefs.setInt('asama4_session_wrong_count', 0);
    // Son tamamlanma zamanını kaydet
    await prefs.setString(
      'asama4_last_session_time',
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama4Soru2()),
          );
        }
      });
    } else {
