...
class Asama4Soru2 extends StatefulWidget {
  ...
  @override
  State<Asama4Soru2> createState() => _Asama4Soru2State();
}
...
class _Asama4Soru2State extends State<Asama4Soru2>
  ...
  void initState() {
    super.initState();
    stages = [
      _Stage('1', 'assets/SIRALAMA_RESIMLERI/Asama4/disfirca/dis1.png'),
      _Stage('2', 'assets/SIRALAMA_RESIMLERI/Asama4/disfirca/dis2.png'),
      _Stage('3', 'assets/SIRALAMA_RESIMLERI/Asama4/disfirca/dis3.png'),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama4Soru3()),
          );
        }
      });
    } else {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              isEnglish
                                  ? 'Sort the tooth brushing steps.'
                                  : 'Diş fırçalama aşamalarını sırala.',
