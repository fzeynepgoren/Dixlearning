...
class Asama4Soru3 extends StatefulWidget {
  const Asama4Soru3({super.key});

  @override
  State<Asama4Soru3> createState() => _Asama4Soru3State();
}
...
class _Asama4Soru3State extends State<Asama4Soru3>
  ...
  void initState() {
    super.initState();
    stages = [
      _Stage('1', 'assets/SIRALAMA_RESIMLERI/Asama4/tirnak/tırnak1.png'),
      _Stage('2', 'assets/SIRALAMA_RESIMLERI/Asama4/tirnak/tırnak2.png'),
      _Stage('3', 'assets/SIRALAMA_RESIMLERI/Asama4/tirnak/tırnak3.png'),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama4Soru4()),
          );
        }
      });
    } else {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              isEnglish
                                  ? 'Sort the nail cutting steps.'
                                  : 'Tırnak kesme aşamalarını sırala.',
