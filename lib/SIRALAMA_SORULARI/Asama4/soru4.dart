...
class Asama4Soru4 extends StatefulWidget {
  ...
  @override
  State<Asama4Soru4> createState() => _Asama4Soru4State();
}
...
class _Asama4Soru4State extends State<Asama4Soru4>
  ...
  void initState() {
    super.initState();
    stages = [
      _Stage('1', 'assets/SIRALAMA_RESIMLERI/Asama4/ayakkabi/ayakkabi1.png'),
      _Stage('2', 'assets/SIRALAMA_RESIMLERI/Asama4/ayakkabi/ayakkabi2.png'),
      _Stage('3', 'assets/SIRALAMA_RESIMLERI/Asama4/ayakkabi/ayakkabi3.png'),
    ];
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const Asama4Soru5()),
          );
        }
      });
    } else {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              isEnglish
                                  ? 'Sort the shoelace tying steps.'
                                  : 'Ayakkabı bağcığı bağlama aşamalarını sırala.',
