...
class AzCokSoru7 extends StatefulWidget {
  const AzCokSoru7({super.key});

  @override
  State<AzCokSoru7> createState() => _AzCokSoru7State();
}

class _AzCokSoru7State extends State<AzCokSoru7> with TickerProviderStateMixin {
  bool? selectedAnswer;
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const AzCokSoru8()),
          );
        }
      });
    } else {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Image.asset(
                              'assets/az_cok_asa1/soru7/az_tenistopu.png',
                              fit: BoxFit.contain,
                            ),
                          ),
                          ...
                          Expanded(
                            child: Image.asset(
                              'assets/az_cok_asa1/soru7/cok_insan.png',
                              fit: BoxFit.contain,
                            ),
                          ),
                          const SizedBox(height: 8),
