...
import 'dart:async';
import 'dart:math';
import 'package:dixlearning/karsilastirma_az_cok/az_cok_asama1/soru7.dart';

class AsamaGecisEkraniKiz extends StatefulWidget {
  const AsamaGecisEkraniKiz({super.key});

  @override
  State<AsamaGecisEkraniKiz> createState() => _AsamaGecisEkraniKizState();
}

class _AsamaGecisEkraniKizState extends State<AsamaGecisEkraniKiz>
