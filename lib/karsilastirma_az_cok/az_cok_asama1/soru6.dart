...
class AzCokSoru6 extends StatefulWidget {
  ...
  @override
  State<AzCokSoru6> createState() => _AzCokSoru6State();
}

class _AzCokSoru6State extends State<AzCokSoru6> with TickerProviderStateMixin {
  bool? selectedAnswer;
  ...
  void checkAnswer(bool isCokYildiz) {
    setState(() {
      selectedAnswer = isCokYildiz;
      isCorrect = isCokYildiz;
      showFeedback = true;
    });
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/az_cok_asa1/soru6/cok_yildiz.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(18),
                                child: Image.asset(
                                  'assets/az_cok_asa1/soru6/az_ucgen.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
