...
class BalikKucukSorusu extends StatefulWidget {
  ...
  @override
  State<BalikKucukSorusu> createState() => _BalikKucukSorusuState();
}

class _BalikKucukSorusuState extends State<BalikKucukSorusu>
  ...
  void _handleSelect(int index) {
    setState(() {
      selectedIndex = index;
      isCorrect = (index == 0); // 0: soldaki küçük balık doğru
      showFeedback = true;
    });
