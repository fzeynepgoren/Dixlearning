...
class BuyukKucukSoru8 extends StatefulWidget {
  const BuyukKucukSoru8({super.key});

  @override
  State<BuyukKucukSoru8> createState() => _BuyukKucukSoru8State();
}

class _BuyukKucukSoru8State extends State<BuyukKucukSoru8>
    ...
    if (isCorrect == true) {
      Future.delayed(const Duration(seconds: 2), () {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const BuyukKucukSoru9()),
        );
      });
    } else {
      Future.delayed(const Duration(seconds: 2), () {
  ...
  Widget build(BuildContext context) {
    ...
    const Color defaultBtnColor = Color(0xFFB39DDB); // açık mor tonları
