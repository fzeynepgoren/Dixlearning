...
class KalinInceAsamaGecisEkrani extends StatefulWidget {
  const KalinInceAsamaGecisEkrani({super.key});

  @override
  State<KalinInceAsamaGecisEkrani> createState() =>
      _KalinInceAsamaGecisEkraniState();
}

class _KalinInceAsamaGecisEkraniState extends State<KalinInceAsamaGecisEkrani>
