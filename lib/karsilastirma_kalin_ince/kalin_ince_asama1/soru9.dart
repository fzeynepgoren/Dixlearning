...
class _KalinInceSoru9State extends State<KalinInceSoru9>
  ...
  void checkAnswer(bool isInce) {
    ...
    // Resim 17 ince (checkAnswer(true) bağlı), Resim 18 kalın (checkAnswer(false) bağlı).
    // İnce olan doğru cevap olduğu için, isInce = true doğru cevaptır.
    ...
    if (isCorrect) {
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          // Bu son soru olduğu için HomeScreen'e yönlendiriyoruz.
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          // First Button (ince dal, Doğru Cevap)
                          SizedBox(
                          ...
                          // Second Button (kalın dal, Yanlış Cevap)
                          SizedBox(
                            width: double.infinity,
                            height: 40,
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: selectedAnswer == false
                                    ? (!isCorrect // Basılan bu, ama doğru cevap ince ise bu yanlış cevaptır
                                    ? Colors.red.shade500
                                    : Colors.green.shade500)
                                    : const Color(0xfffb8686),
                                foregroundColor: Colors.white,
