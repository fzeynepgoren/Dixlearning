...
import 'package:dixlearning/karsilastirma_kalin_ince/kalin_ince_asama1/soru6.dart';

class KalinInceSoru5 extends StatefulWidget {
  const KalinInceSoru5({super.key});

  @override
  State<KalinInceSoru5> createState() => _KalinInceSoru5State();
}

class _KalinInceSoru5State extends State<KalinInceSoru5>
  ...
  void checkAnswer(bool isInce) {
    ...
    // Resim 9 ince (checkAnswer(true) bağlı), Resim 10 kalın (checkAnswer(false) bağlı).
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => const KalinInceSoru6(),
            ),
          );
        }
      });
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru5/Resim9.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(18),
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru5/Resim10.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              // *** DÜZELTME: ElevatedButton.from yerine styleFrom kullanıldı ***
                              style: ElevatedButton.styleFrom(
