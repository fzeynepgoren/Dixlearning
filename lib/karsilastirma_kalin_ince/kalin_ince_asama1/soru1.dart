...
class KalinInceSoru1 extends StatefulWidget {
  const KalinInceSoru1({super.key});

  @override
  State<KalinInceSoru1> createState() => _KalinInceSoru1State();
}

class _KalinInceSoru1State extends State<KalinInceSoru1>
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const KalinInceSoru2()),
          );
        }
      });
    } else {
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/kalin_ince_asa1/soru1/Resim1.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(18),
                                    child: Image.asset(
                                      'assets/kalin_ince_asa1/soru1/Resim2.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                ),
