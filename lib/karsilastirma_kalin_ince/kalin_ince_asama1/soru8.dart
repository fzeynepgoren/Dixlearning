...
class KalinInceSoru8 extends StatefulWidget {
  const KalinInceSoru8({super.key});

  @override
  State<KalinInceSoru8> createState() => _KalinInceSoru8State();
}

class _KalinInceSoru8State extends State<KalinInceSoru8>
  ...
  void checkAnswer(bool isKalin) {
    ...
    // Resim 15 ince (checkAnswer(false) bağlı), Resim 16 kalın (checkAnswer(true) bağlı).
    // Kalın olan doğru cevap olduğu için, isKalin = true doğru cevaptır.
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => const KalinInceSoru9(),
            ),
          );
        }
      });
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru8/Resim15.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          // First Button (ince ip, Yanlış Cevap)
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: selectedAnswer == false
                                    ? (!isCorrect // Basılan bu, ama doğru cevap kalın ise bu yanlış cevaptır
                                    ? Colors.red.shade500
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(18),
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru8/Resim16.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          // Second Button (kalın ip, Doğru Cevap)
                          SizedBox(
                            width: double.infinity,
                            height: 40,
                            child: ElevatedButton(
