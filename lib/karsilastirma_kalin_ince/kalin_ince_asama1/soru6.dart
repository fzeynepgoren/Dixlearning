...
import 'package:dixlearning/karsilastirma_kalin_ince/kalin_ince_asama1/soru7.dart';

class KalinInceSoru6 extends StatefulWidget {
  const KalinInceSoru6({super.key});

  @override
  State<KalinInceSoru6> createState() => _KalinInceSoru6State();
}

class _KalinInceSoru6State extends State<KalinInceSoru6>
  ...
  void checkAnswer(bool isKalin) {
    ...
    // Resim 11 ince (checkAnswer(false) bağlı), Resim 12 kalın (checkAnswer(true) bağlı).
    // İnce olan doğru cevap olduğu için, isKalin'in tersi doğru cevaptır.
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => const KalinInceSoru7(),
            ),
          );
        }
      });
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru6/Resim11.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          // First Button (ince çizgi, Doğru Cevap)
                          SizedBox(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(18),
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru6/Resim12.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          // Second Button (kalın çizgi, Yanlış Cevap)
                          SizedBox(
                            width: double.infinity,
                            height: 40,
                            child: ElevatedButton(
