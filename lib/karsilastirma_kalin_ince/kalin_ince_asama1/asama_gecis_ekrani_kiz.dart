...
class KalinInceAsamaGecisEkraniKiz extends StatefulWidget {
  const KalinInceAsamaGecisEkraniKiz({super.key});

  @override
  State<KalinInceAsamaGecisEkraniKiz> createState() =>
      _KalinInceAsamaGecisEkraniKizState();
}

class _KalinInceAsamaGecisEkraniKizState
    extends State<KalinInceAsamaGecisEkraniKiz> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final maskotSize = screenWidth * 1.20; // BÜYÜK MASKOT
