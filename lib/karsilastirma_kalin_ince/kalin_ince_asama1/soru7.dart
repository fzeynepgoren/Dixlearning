...
import 'package:dixlearning/karsilastirma_kalin_ince/kalin_ince_asama1/soru8.dart';

class KalinInceSoru7 extends StatefulWidget {
  const KalinInceSoru7({super.key});

  @override
  State<KalinInceSoru7> createState() => _KalinInceSoru7State();
}

class _KalinInceSoru7State extends State<KalinInceSoru7>
      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => const KalinInceSoru8()),
          );
        }
      });
    } else {
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru7/Resim13.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(18),
                                child: Image.asset(
                                  'assets/kalin_ince_asa1/soru7/Resim14.png',
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
