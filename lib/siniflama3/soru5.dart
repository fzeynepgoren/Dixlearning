...
=======
  ...
  Future<int> _calculateStars() async {
    ...
    // Toplam doğru cevap sayısı (soru1: 6, soru2: 6, soru4: 6, soru5: 6)
    const int totalCorrect = 24;
...
>>>>>>> Stashed changes
    ...
    await prefs.setInt('siniflama_level_3_stars', stars);
