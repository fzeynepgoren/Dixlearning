...
class EslemeSorulariScreen extends StatefulWidget {
  const EslemeSorulariScreen({super.key});

  @override
  State<EslemeSorulariScreen> createState() => _EslemeSorulariScreenState();
}

class _EslemeSorulariScreenState extends State<EslemeSorulariScreen>
  ...
  Future<void> _loadProgress() async {
    ...
    setState(() {
      ...
      for (int i = 1; i <= 4; i++) {
        levelStars[i] = prefs.getInt('esleme_level_${i}_stars') ?? 0;
      }
    });
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  const Color(0xFFB8E6F9), // Açık mavi
                  const Color(0xFFC9F0FF), // Orta mavi
                  const Color(0xFFE8F8FF), // Açık beyaz-mavi
                ],
              ),
            ),
          ),
          ...
          Stack(
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    // Level 1: Meyve Eşleme (En alt - ortada başlangıç)
                    _buildLevelButton(
                      context,
                      level: 1,
                      leftFactor: 0.50,
