    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/screensphoto/karsilastirma.png',
              fit: BoxFit.cover,
          ...
          Stack(
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    // Level 1: Az-Çok (En alt kıvrım - ortada başlangıç)
                    _buildLevelButton(
                      context,
                      level: 1,
                      leftFactor: 0.50,
                    ...
                    // Level 2: Büyük-Küçük (Orta-alt kıvrım - solda)
                    _buildLevelButton(
                      context,
                      level: 2,
                      leftFactor: 0.30,
                    ...
                    // Level 3: Kalın-İnce (Orta-üst kıvrım - sağda)
                    _buildLevelButton(
                      context,
                      level: 3,
                      leftFactor: 0.68,
                    ...
                    // Level 4: Uzun-Kısa (Üst kıvrım - solda)
                    _buildLevelButton(
                      context,
                      level: 4,
                      leftFactor: 0.35,
