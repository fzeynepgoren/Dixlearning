...
class UzunKisaAsamaGecisEkrani extends StatefulWidget {
  const UzunKisaAsamaGecisEkrani({super.key});

  @override
  State<UzunKisaAsamaGecisEkrani> createState() =>
      _UzunKisaAsamaGecisEkraniState();
}

class _UzunKisaAsamaGecisEkraniState extends State<UzunKisaAsamaGecisEkrani>
