...
class KisaUzunYolSorusu extends StatefulWidget {
  ...
  @override
  State<KisaUzunYolSorusu> createState() => _KisaUzunYolSorusuState();
}

class _KisaUzunYolSorusuState extends State<KisaUzunYolSorusu>
  ...
  void _handleSelect(int index) {
    setState(() {
      selectedIndex = index;
      isCorrect = (index == 0); // 0: kısa yol (soldaki)
      showFeedback = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    const Color defaultBtnColor = Color(0xFFBDBDBD); // gri
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(24),
                                    child: Image.asset(
                                      'assets/uzun_kisa/soru3/yollar.png',
                                      fit: BoxFit.cover,
                                      width: double.infinity,
