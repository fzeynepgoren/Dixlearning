...
class UzunKisaAgacSorusu extends StatefulWidget {
  const UzunKisaAgacSorusu({super.key});

  @override
  State<UzunKisaAgacSorusu> createState() => _UzunKisaAgacSorusuState();
}

class _UzunKisaAgacSorusuState extends State<UzunKisaAgacSorusu>
  ...
  void _handleSelect(int index) {
    setState(() {
      selectedIndex = index;
      isCorrect = (index == 0); // 0: uzun ağaç (soldaki)
      showFeedback = true;
    });
    ...
    if (isCorrect == true) {
      Future.delayed(const Duration(seconds: 2), () {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (context) => const KisaUzunKalemSorusu()),
        );
      });
    } else {
      Future.delayed(const Duration(seconds: 2), () {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(24),
                                    child: Image.asset(
                                      'assets/uzun_kisa/soru1/agaclar.jpg',
                                      fit: BoxFit.cover,
                                      width: double.infinity,
