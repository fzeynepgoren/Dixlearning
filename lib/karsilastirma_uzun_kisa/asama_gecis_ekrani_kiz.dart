...
class UzunKisaAsamaGecisEkraniKiz extends StatefulWidget {
  const UzunKisaAsamaGecisEkraniKiz({super.key});

  @override
  State<UzunKisaAsamaGecisEkraniKiz> createState() =>
      _UzunKisaAsamaGecisEkraniKizState();
}

class _UzunKisaAsamaGecisEkraniKizState
    extends State<UzunKisaAsamaGecisEkraniKiz> with TickerProviderStateMixin {
  ...
  void _onContinue() async {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => const KisaUzunCocukSorusu()),
    );
  }
