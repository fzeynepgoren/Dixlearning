...
class UzunKisaPalmiyeSupurgeSorusu extends StatefulWidget {
  ...
  @override
  State<UzunKisaPalmiyeSupurgeSorusu> createState() =>
      _UzunKisaPalmiyeSupurgeSorusuState();
}

class _UzunKisaPalmiyeSupurgeSorusuState
    extends State<UzunKisaPalmiyeSupurgeSorusu> with TickerProviderStateMixin {
  int? selectedIndex;
  bool? isCorrect;
  ...
  void _handleSelect(int index) {
    setState(() {
      selectedIndex = index;
      isCorrect = (index == 0); // 0: palmiye (soldaki) - uzun olan
      showFeedback = true;
    });
    ...
    if (isCorrect == true) {
      Future.delayed(const Duration(seconds: 2), () {
        ...
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
              builder: (context) => const UzunKisaMantarSemsiyeSorusu()),
        );
      });
    } else {
      Future.delayed(const Duration(seconds: 2), () {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(24),
                                    child: Image.asset(
                                      'assets/uzun_kisa/soru8/palmiyevesupurge.png',
                                      fit: BoxFit.cover,
                                      width: double.infinity,
